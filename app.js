...
angular.module('MainApp.controllers', []).
  controller('mainController', function ($scope) {
    ...
    $scope.selectWave = function (wave, index) {
    ...
    var colors = {
      "Asia": [318, 65, 67],
      "North America": [8, 100, 52],
      "Africa": [30, 100, 73],
      "South America": [110, 57, 70],
      "Europe": [185, 56, 73],
      "Oceania": [204, 70, 41]
    };
    ...
    function loadData(wave) {
      // Load the data and visualization
      const path = `data/${wave}.csv`;
      d3.csv(path, function (raw_data) {
